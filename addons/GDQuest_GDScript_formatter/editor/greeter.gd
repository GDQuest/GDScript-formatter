...
@onready var _formatter_install_button: Button = $Container/Layout/Versions/Formatter/Layout/Actions/InstallButton
@onready var _formatter_uninstall_button: Button = $Container/Layout/Versions/Formatter/Layout/Actions/UninstallButton
...
func _ready() -> void:
	...
	_formatter_install_button.button_down.connect(_handle_formatter_install)
	_formatter_uninstall_button.button_down.connect(_handle_formatter_uninstall)
...
func _handle_close() -> void:
	...
	_formatter_install_button.button_down.disconnect(_handle_formatter_install)
	_formatter_uninstall_button.button_down.disconnect(_handle_formatter_uninstall)
...
func _handle_formatter_install() -> void:
	action_pressed.emit("install_update")


func _handle_formatter_uninstall() -> void:
	action_pressed.emit("uninstall")
