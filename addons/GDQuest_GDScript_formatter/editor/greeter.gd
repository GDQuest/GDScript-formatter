...
@onready var _docs_button: Button = $Container/Padding/Layout/Resources/Docs/HBoxContainer/DocsButton
@onready var _issues_button: Button = $Container/Padding/Layout/Resources/Issues/HBoxContainer/IssuesButton
